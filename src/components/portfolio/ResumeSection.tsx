  ...
  >
    <div className="flex gap-4">
      ...
      <div className="flex flex-col items-center">
        <div className={`w-4 h-4 rounded-full border-2 ${isCurrent ? 'bg-green-400 border-green-400' : 'bg-cyan-400 border-cyan-400'} mb-2`} />
        <div className="w-1 h-32 bg-gradient-to-b from-cyan-400/50 to-cyan-400/10" />
      </div>
      
      {/* Content */}
      <div className="pb-8 flex-1">
        <div className="bg-slate-900/50 border border-cyan-400/20 rounded-xl p-6 hover:border-cyan-400/50 transition-all">
          <div className="flex items-start justify-between mb-3">
            <div>
              <h3 className="text-xl font-bold text-cyan-300">{role}</h3>
...
export const ResumeSection = () => {
  ...
  return (
    <section id="resume" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 -right-40 w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl -z-10" />
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            ...
            >
              ...
              <div className="text-sm text-slate-300">Programming Languages</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center p-6 bg-slate-900/50 border border-cyan-400/20 rounded-xl"
            >
              <div className="text-3xl font-bold text-cyan-300 mb-2">6+</div>
              <div className="text-sm text-slate-300">Data Tools & Platforms</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm text-slate-300">Major Projects Delivered</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center p-6 bg-slate-900/50 border border-cyan-400/20 rounded-xl"
            >
              <div className="text-3xl font-bold text-cyan-300 mb-2">20%</div>
              <div className="text-sm text-slate-300">Efficiency Improvement</div>
            </motion.div>
          </motion.div>

          {/* Key Achievements */}
          <motion.div variants={itemVariants} className="bg-gradient-to-r from-cyan-900/30 to-sky-900/30 border border-cyan-400/20 rounded-2xl p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-slate-400 text-sm">Performed comprehensive exploratory analysis on multi-dimensional datasets using Python pandas, SQL, and Jupyter notebooks to uncover hidden patterns.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-400 text-sm">Engineered custom Power BI dashboards with advanced DAX measures that reduced reporting time by 20% and improved decision-making speed.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-400 text-sm">Implemented rigorous data validation and cleaning protocols to ensure data integrity, resulting in higher confidence in downstream analytical models.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-400 text-sm">Optimized complex SQL queries to enhance query performance and scalability, enabling faster data retrieval for real-time dashboards.</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            <p className="text-slate-400 text-sm mt-4">Last updated: November 2025</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
